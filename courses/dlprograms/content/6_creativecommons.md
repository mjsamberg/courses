...
AI has created a lot of concern in the intellectual property space. The clearest guidance so far comes from Bartz v. Anthropic, where a federal judge ruled that [training an AI model on lawfully acquired books is fair use](https://www.nbcnews.com/tech/tech-news/federal-judge-rules-copyrighted-books-are-fair-use-ai-training-rcna214766), but that [Anthropic's use of pirated copies to build its training library was not](https://www.npr.org/2026/07/27/nx-s1-5904606/anthropic-vs-bartz-ai-copyright-lawsuit-pros-cons) — that piracy claim alone led to a $1.5 billion settlement with the affected authors. In short: how you acquire the training data matters as much as what you do with it.


It's important to remember that Creative Commons licenses don't override Copyright law. CC licenses simply state the terms and conditions under which you allow others to use your copyrighted works. Therefore, if AI training is Fair Use, [CC licenses may not apply](https://creativecommons.org/using-cc-licensed-works-for-ai-training-2/). CC licenses would likely apply if the AI is using the work in a way that is not Fair Use (creating a direct adaptation or remix, citing or referencing the work in another work, etc.). In that case, the user of the AI is bound by the CC terms the same as if they were not using AI.
