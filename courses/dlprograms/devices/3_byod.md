...
Early data on cell phone bans have [suggested positive results](https://www.nytimes.com/2025/09/17/opinion/phone-bans-schools-kids.html). Anecdotally, principals, teachers, and students report [increased engagement and socialization](https://www.wunc.org/education/2025-09-15/nc-school-cell-phone-ban-policy-wake-county-schools-students) among students. Many school districts are seeing [surges in library book circulation](https://www.jefferson.kyschools.us/o/brandeis/article/2390011). Chatham County Schools in North Carolina ran a pilot with Yondr pouches for 2024-2025. Early data suggests a [31% reduction in student suspensions](https://simbli.eboardsolutions.com/Meetings/Attachment.aspx?S=190&AID=441890&MID=17133) at one school, along with a [76% reduction in failing grades](https://simbli.eboardsolutions.com/Meetings/Attachment.aspx?S=190&AID=427210&MID=16606) at the end of the first semester at the same school. Ironically, some schools are also seeing a surge in students brigning older electronic devices to school such as [iPods and CD players](https://www.nytimes.com/2025/09/11/style/phone-ban-ipod-mp3-school.html). However, schools are also having to readjust policies since tools like digital hall passes that students carry on their phone are no longer viable. 
...
Cell phone bans didn't emerge in a vacuum - they're the most visible response to a much broader anxiety about how much time kids spend looking at screens, in and out of school. A [2023 Common Sense Media study found 95% of school-aged children had smartphone access](https://www.commonsensemedia.org/sites/default/files/research/report/2023-cs-smartphone-research-report_final-for-web.pdf), and concerns about the mental health, attention, and academic effects of that access have only grown since. But the debate has increasingly spilled over from personal phones to school-issued devices.

Several states have already started regulating instructional screen time directly, not just personal devices. [Alabama and Utah passed the first laws restricting classroom screen time for early elementary students in 2026](https://www.multistate.us/insider/2026/4/8/elementary-school-screen-time-limits-gain-momentum-in-2026), Iowa and Oklahoma capped K-5 screen time at 60 minutes a day, and Kansas moved to prohibit digital devices in early elementary classrooms outright. [Los Angeles Unified became the first major district to adopt classroom screen time limits by board vote](https://edtech.lausd.org/apps/pages/index.jsp?uREC_ID=4455629&type=d&pREC_ID=2747495&tota11y=true), with implementation starting this fall. [Granville County, NC has gone tech free](https://www.theassemblync.com/news/education/education-tech-backlash-public-schools-granville/) one day per week.

This is happening at the same time a [U.S. Surgeon General's advisory declared harmful screen use by children a public health concern](https://www.winssolutions.org/us-education-department-ed-tech-guidance/). Increasingly, parent pressure has also played a factor in these bans. Groups have formed, such as the [Chapel Hill-Carrboro Parents for Intentional Technology Use](https://www.intentionaltechchccs.org). A lot of the pushback is against YouTube specifically, which features centrally in [New York's ban](https://www.nbcnewyork.com/video/on-air/as-seen-on/new-york-city-council-could-ban-youtube-as-it-looks-to-limit-screen-time-in-schools/6548196/).

However, the professional organizations most directly responsible for classroom technology have pushed back on blanket time limits as the right tool. In August 2026, [CoSN released guidance explicitly advising districts against strict screen time limits](https://www.cosn.org/from-screen-time-mandates-to-purposeful-technology-policies-and-guidance/), arguing that "not all screen time is the same" and that policy should focus on whether technology is being used purposefully rather than how many minutes it's on. Around the same time, [ISTE released an evidence summary making a similar case](https://iste-ascd.org/screentime-to-screenvalue): research on consumer apps and social media doesn't necessarily apply to well-designed instructional tools, and implementation (teacher training, curriculum alignment) matters as much as the tool itself. [NC DPI has also released their statewide guidance](https://www.ednc.org/wp-content/uploads/2026/07/NCDPI-Guidance-for-Purposeful-Screen-Use-in-Schools.pdf), which sets no maximum screen time for any grade level and instead asks schools to distinguish **active** use (creating, problem-solving, collaborating) from **passive** use (scrolling, background video), directing schools to restrict the latter while protecting the former.

Taken together, CoSN, ISTE, and DPI are converging on a similar recommendation to keep the purpose of technology at the center, treat good instruction as good instruction, prioritize assistive technologies, support teachers, and build transparency. 
