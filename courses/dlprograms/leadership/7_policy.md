...
There are two additional exceptions to FERPA in addition to directory information. The first is the "school official" exception. School officials with a legitimate educational interest may access student records. Note that BOTH conditions may apply – the person must be a school official, and accessing the record must be in the course of the official carrying out their official duties. For example, a teacher looking up grades for a neighbor’s child would violate FERPA – while the teacher is a school official, they do not have a legitimate educational interest to know those grades. 

The third exception is for the safety of the child. In the event of an imminent or active threat to a child, the school may disclose student information to law enforcement, fire, or medical personnel. This is for an active or imminent threat only, not a potential threat. This covers situations like a potential student suicide, bus accident, or a lockdown situation. 


When selecting educational tools, school personnel need to ask vendors what data they are collecting from students and how it intends to be used. Vendors do not violate FERPA, schools do by providing vendors with data to use in a way that is a FERPA violation. More accurately, vendors have no obligations under FERPA. The provisions are usually in the contract or a data processing amendment. For example, Google enters the following text into their license agreement for GSuite for Education:
...
Basically, Google declares themselves as school officials under the second exception to FERPA. This text means that the school delegates legal authority to Google to host and maintain student records (i.e. homework assignments and grades in Google Classroom) and Google has an [extra data processing agreement limiting the use of this data](https://gsuite.google.com/terms/dpa_terms.html). Because this is part of the GSuite for Education license agreement, it only applies for GSuite for Education accounts. Therefore, a school or teacher using a personal Google account or requiring students to do so would be in violation of FERPA privacy laws if they transmitted or stored any student information via that account. 

Many people are, for example, looking at using tools such as Amazon Alexa in the classroom. Because there is no FERPA clause in the Alexa license agreement, the prevailing thinking currently is that using Alexa in the classroom is a violation of FERPA. 

One item to note is that FERPA is the prevailing rule for medical information for students. HIPAA does not apply to public schools unless they are running health clinics. This does mean that any medical information disclosed to a school complies with FERPA exceptions. This is necessary for the operation of the school. For example, a teacher is a school official with a legitimate educational interest to know if a diabetic student is in their classroom. Or a school would need to disclose a latex allergy to a paramedic intervening during a medical emergency.
